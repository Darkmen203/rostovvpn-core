...
const (
	Hello_SayHello_FullMethodName       = "/rostovvpnrpc.Hello/SayHello"
	Hello_SayHelloStream_FullMethodName = "/rostovvpnrpc.Hello/SayHelloStream"
)
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rostovvpnrpc.Hello",
	...
	Metadata: "rostovvpn.proto",
}

const (
	Core_Start_FullMethodName                   = "/rostovvpnrpc.Core/Start"
	Core_CoreInfoListener_FullMethodName        = "/rostovvpnrpc.Core/CoreInfoListener"
	Core_OutboundsInfo_FullMethodName           = "/rostovvpnrpc.Core/OutboundsInfo"
	Core_MainOutboundsInfo_FullMethodName       = "/rostovvpnrpc.Core/MainOutboundsInfo"
	Core_GetSystemInfo_FullMethodName           = "/rostovvpnrpc.Core/GetSystemInfo"
	Core_Setup_FullMethodName                   = "/rostovvpnrpc.Core/Setup"
	Core_Parse_FullMethodName                   = "/rostovvpnrpc.Core/Parse"
	Core_ChangeRostovVPNSettings_FullMethodName = "/rostovvpnrpc.Core/ChangeRostovVPNSettings"
	Core_StartService_FullMethodName            = "/rostovvpnrpc.Core/StartService"
	Core_Stop_FullMethodName                    = "/rostovvpnrpc.Core/Stop"
	Core_Restart_FullMethodName                 = "/rostovvpnrpc.Core/Restart"
	Core_SelectOutbound_FullMethodName          = "/rostovvpnrpc.Core/SelectOutbound"
	Core_UrlTest_FullMethodName                 = "/rostovvpnrpc.Core/UrlTest"
	Core_GenerateWarpConfig_FullMethodName      = "/rostovvpnrpc.Core/GenerateWarpConfig"
	Core_GetSystemProxyStatus_FullMethodName    = "/rostovvpnrpc.Core/GetSystemProxyStatus"
	Core_SetSystemProxyEnabled_FullMethodName   = "/rostovvpnrpc.Core/SetSystemProxyEnabled"
	Core_LogListener_FullMethodName             = "/rostovvpnrpc.Core/LogListener"
)
...
type CoreClient interface {
	...
	ChangeRostovVPNSettings(ctx context.Context, in *ChangeRostovVPNSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error)
...
func (c *coreClient) ChangeRostovVPNSettings(ctx context.Context, in *ChangeRostovVPNSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoreInfoResponse)
	err := c.cc.Invoke(ctx, Core_ChangeRostovVPNSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	ChangeRostovVPNSettings(context.Context, *ChangeRostovVPNSettingsRequest) (*CoreInfoResponse, error)
	//rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
...
func (UnimplementedCoreServer) ChangeRostovVPNSettings(context.Context, *ChangeRostovVPNSettingsRequest) (*CoreInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeRostovVPNSettings not implemented")
}
...
func _Core_ChangeRostovVPNSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeRostovVPNSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ChangeRostovVPNSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ChangeRostovVPNSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ChangeRostovVPNSettings(ctx, req.(*ChangeRostovVPNSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeRostovVPNSettings",
			Handler:    _Core_ChangeRostovVPNSettings_Handler,
		},
		{
...
const (
	TunnelService_Start_FullMethodName  = "/rostovvpnrpc.TunnelService/Start"
	TunnelService_Stop_FullMethodName   = "/rostovvpnrpc.TunnelService/Stop"
	TunnelService_Status_FullMethodName = "/rostovvpnrpc.TunnelService/Status"
	TunnelService_Exit_FullMethodName   = "/rostovvpnrpc.TunnelService/Exit"
)
...
var TunnelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rostovvpnrpc.TunnelService",
